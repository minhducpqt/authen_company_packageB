...
from utils.auth import get_access_token  # helper sẵn có
...
class AuctionDocsClient:
    ...
    def get_registration_doc_payload(
        ...
        *,
        ...
        """
        Gọi A:
        GET /api/v1/business/documents/auction/registration?project_code=...&cccd=...
        """
        params = {
...
def fetch_registration_doc_payload(
    ...
    """
    Lấy access token từ request rồi gọi sang Service A.
    """
